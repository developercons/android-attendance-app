...
public class AppBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        divisions.add("BCA");
        divisions.add("BSc COMPUTER SCIENCE");
        divisions.add("BSc CHEMISTRY");
        divisions.add("BSc PHYSICS");
        divisions.add("BSc BIOTECHNOLOGY");
        divisions.add("MCA");
        divisions.add("MSc COMPUTER SCIENCE");
        divisions.add("MSc CHEMISTRY");
        divisions.add("MSc PHYSICS");
        divisions.add("MSc BIOTECHNOLOGY");
